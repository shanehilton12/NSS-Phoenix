...
/obj/item/clothing/accessory/holster(obj/item/weapon/gun/projectile/O,v as num)
O.PHolst = PHolst1
/obj/item/clothing/accessory/holster(obj/item/weapon/gun/energy/O,v as num)
O.PHolst = PHolst2
